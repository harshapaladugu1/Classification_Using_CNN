...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("Summary Statistics for Classification Using " + model.upper() + " Architecture")
    print("{:10}: {:3d}".format('Number of Images', results_stats_dic['n_images']))
    print("{:10}: {:3d}".format('Number of Dog Images', results_stats_dic['n_dogs_img']))
    print("{:10}: {:3d}".format('Number of Non-Dog Images', results_stats_dic['n_notdogs_img']))
    ...
    if print_incorrect_breed and  results_stats_dic['pct_correct_breed']<100:
        ...
        for key in results_dic:
                if results_dic[key][3] ==1 and results_dic[key][4] ==1 and results_dic[key][2] ==0:
                        print("Actual Breed: " + results_dic[key][0]+ "  |  Classified As: " +results_dic[key][1])
